...
- **Budget: you have at most {{TURNS}} tool turns.** Batch several reads or greps in one turn. Do not re-read the diff from disk, and do not browse beyond what the map and your symbol grep point at. Spend the last turn on the verdict.
