...
- Docs: README "Email protection" (what ships, when it becomes a link, and the honest limit: it defeats harvesters that read HTML or run without interaction, which is nearly all of them; a bot driving a full browser and faking input still reads it; the strongest protection is a forwarding alias you can rotate), the vCard note, `docs/security.md` "The email shield (WP17)", `docs/invariants.md` rules 17 and 18 (numbered 20 and 21 on the branch; WP19 renumbered them after WP18 took 16).
