...
Status: v1 done. WP6 release tooling done. WP7 (personal data out of git) done. Open: real content from Ricardo, Safari/Firefox manual check, history rewrite to drop old attribution trailers. Next: section 13 (Pexels).
